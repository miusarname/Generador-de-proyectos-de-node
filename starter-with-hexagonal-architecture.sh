...
" > default.js && cd .. && cd dominio && echo "// Aca va el codigo de los DTOs es decir el codigo que 'prepara' tu codigo para ser tocado por los controladores, por ejemplo esto:
...
"> default.models.js && cd .. && cd aplicacion && echo "// Aca va el codigo de los controladores, es decir las funciones que recibiran el 'request'(req) y el 'response(res),y aca tambien importaremos la logica de la infraestructura, por ejemplo:
...
"> default.controller.js && echo "// Aca van las rutas, por ejemplo :
